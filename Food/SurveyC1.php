...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
       ...
       <div class="w3-white w3-container">
            <h2>Questions about your search for <b><?php echo($_SESSION['c1qt']);?></b> and <b><?php echo($_SESSION['c2qt']);?></b> </h2>
            <p> Below, we have formulated a number of propositions about the list of recipes for your search query for <b><?php echo($_SESSION['c1qt']);?></b> and <b><?php echo($_SESSION['c2qt']);?></b> and your chosen recipe. Please indicate to what extent you (dis)agree with each of them. 
...
<div class="w3-row w3-border">
		...
		<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >The list of recipes was not attractive</div>
		  ...
		  <div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >The list of recipes matched my preferences</div>
		 ...
		 <h5>Chosen recipe</h5>
		<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >I liked the chosen recipe</div>
		...
		<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px">I would enjoy eating the chosen recipe</div>
