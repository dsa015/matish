...
$d=array(array("Pasta","Burger"), array("Salad", "Curry")); 
$s=array();
//define 4 orders

$s[0]=array("queryBase.php");

$_SESSION['c1q']=$s[$condnum%1][0];
$_SESSION['c1qt']=$d[0][0];
$_SESSION['c2q']=$s[$condnum%1][0];
$_SESSION['c2qt']=$d[0][1];
$_SESSION['c3q']=$s[$condnum%1][0];
$_SESSION['c3qt']=$d[1][0];
$_SESSION['c4q']=$s[$condnum%1][0];
$_SESSION['c4qt']=$d[1][1];
