...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
       ...
       <div class="w3-white w3-container">
            <h2>Questions about your search for <b><?php echo($_SESSION['c3qt']);?></b> and <b><?php echo($_SESSION['c4qt']);?></b> </h2>
            <p> Below, we have formulated a number of propositions about the list of recipes for your search query <b><?php echo($_SESSION['c3qt']);?></b> and <b><?php echo($_SESSION['c4qt']);?></b> and your chosen recipe. Please indicate to what extent you (dis)agree with each of them. 
