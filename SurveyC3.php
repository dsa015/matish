...
<FORM id="mlwebform" name="mlwebform" onSubmit="return checkForm(this)" method="POST" action="save.php">
       ...
       <div class="w3-white w3-container">
            <h2>Questions about your searches for recipes </h2>
            <p> Below, we have formulated a number of propositions about the lists of recipes for your search queries. Please indicate to what extent you (dis)agree with each of them. 
...
<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px">I liked list number 1 better than list number 2</div>
		...
		<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >I liked list number 2 better than list number 1</div>
		  ...
		  <div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >I found list number 1 to match my preferences</div>
		  ...
		  <div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >I found list number 2 to match my preferences </div>
		  ...
		  <div class="w3-container w3-col w3-gray w3-center w3-hover-blue" style="width: 10%;" ><input class="w3-radio" type="radio" name="Rec-q5" value="2" required> 5</div>
			...
			<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px">I found the recipes from list number 1 the most pleasing</div>
		...
		<div class="w3-row w3-border">
		  <div class="w3-container w3-col w3-light-grey w3-left-align w3-hover-blue" style="width: 50%;height: 30px" >I found the recipes from list number 2 the most pleasing</div>
